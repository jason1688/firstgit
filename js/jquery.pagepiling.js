    ...
    $.fn.pagepiling = function (custom) {
        ...
        */
        function scrollPage(destination, animated) {
            ...
            //ADLAI'S MODIFIED CODE
            divAnimationLast = divAnimationCurr;
            divAnimationCurr = ($(v.destination[0].id).find(".animation"));
            $("#" + divAnimationCurr.selector).show();
            setTimeout(function() {
              $("#" + divAnimationLast.selector).hide();
            },1100);

            if(v.destination[0].id == "ib_work") {
              setTimeout(function() {
                v.destination.addClass('pp-scrollable');
                v.destination.removeClass('pp-table');
              }, 1100);
                $(".small_copy_text a").css('color','black');
            }
            else {
              $('#ib_work').removeClass('pp-scrollable');
              $('#ib_work').addClass('pp-table');
              $(".small_copy_text a").css('color','white');
            }
